...
@section('adminpage-content')
    ...
    <div
            class="relative flex flex-col w-full h-full overflow-hidden text-gray-700 bg-white bg-clip-border">
                    ...
                    <td class="">
                        <div class="flex justify-center gap-x-2">
                            <a href="{{ route('adminpage.product.edit', ['id' => $product->id]) }}">
                                <img
                                        src="https://img.icons8.com/material-outlined/50/FFFFFF/edit.png" alt="edit"
                                        class="bg-green-700 rounded p-1 size-7 cursor-pointer"/>
                            </a>
                            <form id="delete-product-form-{{ $product->id }}"
                                  action="{{ route('adminpage.product.delete', ['id' => $product->id]) }}"
