        ...
        <div class="border-b border-gray-900/10 pb-12">
            ...
            <div class="mt-10 flex-col flex gap-y-8">
                ...
                <div class="col-span-full">
                    ...
                    <div class="mt-2">
                        <textarea placeholder="Masukkan Deskripsi Dari Produk." name="description" rows="5"
                            class="px-3 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6">{{ $product->name }}</textarea>
                    </div>
                </div>
                ...
                <div class="flex justify-center items-center gap-x-12">
                    ...
                    <div class="sm:col-span-4 w-full">
                        <label for="stock" class="block text-sm/6 font-medium text-gray-900">Stok</label>
                        <div class="mt-2">
                            <div
                                class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600">
                                <input type="number" name="stock" autocomplete="stock"
                                    class="block flex-1 border-0 bg-transparent py-1.5 pl-3 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm/6"
